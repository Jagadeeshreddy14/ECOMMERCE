...
export const OtpVerfication = () => {
    ...
    return (
        <Stack width={'100vw'} height={'100vh'} noValidate flexDirection={'column'} rowGap={3} justifyContent="center" alignItems="center" sx={{ backgroundColor: '#f0f2f5', padding: '2rem' }}>
            <Stack component={Paper} elevation={3} position={'relative'} justifyContent={'center'} alignItems={'center'} p={'2rem'} rowGap={'2rem'} sx={{ maxWidth: '400px', width: '100%' }}>
